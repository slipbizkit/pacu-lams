...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/director/history', label: 'Completed Transactions', icon: 'bi-clock-history', roles: ['director'], group: 'history' },
  { to: '/account', label: 'My Account', icon: 'bi-person-gear', roles: ['personnel', 'lawyer', 'admin', 'support_staff', 'director'], group: 'settings' },
